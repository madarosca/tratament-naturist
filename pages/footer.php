...
<div class="container-fluid">
    <div class="container" id="container-footer">
        ...
        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12" id="googleMap">
        </div>
        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 social_media">
            <h5 class="footer_header text-center"><i class="fa fa-users"></i>  Site-uri partenere</h5>
...
<div id="scroll_to_top" data-toggle="tooltip" data-placement="left" title="Sus"><a href="#top"><i class="fa fa-angle-double-up"></i></a></div>
